    ...
    <div className="bg-white py-16">
      ...
      <section aria-label="Profile introduction" className="lg:grid lg:grid-cols-3 lg:gap-12 items-start">
        ...
        <div className="lg:col-span-2 mt-12 lg:mt-0">
          ...
          <p className="mt-4 text-lg text-gray-700 leading-relaxed pr-20">
      ...
      <section className="mt-20 px-20" aria-labelledby="strengths-heading">
      ...
      <section className="mt-20 px-20" aria-labelledby="philosophy-heading">
      ...
      <section className="mt-20 px-20" aria-labelledby="expertise-heading-about">
      ...
      <section className="mt-20 px-20" aria-labelledby="journey-heading">
      ...
      <section className="mt-20 px-20" aria-labelledby="roles-heading">
