...
const HomePage: React.FC = () => {
  ...
  useEffect(() => {
    document.title = "Home | Dr. Ashutosh Mishra - Supreme Court Advocate | Professor of Management & Law | Author | NLP Master Practitioner | Psychologist | PhD Guide | PMP | IIM Ahmedabad Alumnus";
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
            ...
            <div className="p-4">
              ...
              <p className="text-gray-600 mt-2">Supreme Court Bar Association</p>
            </div>
          </div>
        </div>
      </section>
