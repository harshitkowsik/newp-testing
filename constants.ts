...
export const startups = [
  { id: 'way2hosting', name: 'Way 2 Hosting', description: 'Deals in web hosting, domain registration, and web design with 24x7 technical support for individuals and enterprises.', image: 'resources/startups/baNK-768x174-1-300x68.png' },
  ...
  { id: 'kayteeled', name: 'KAYTEE LED Lights', description: 'A manufacturing and B2B trade project producing premium quality LED bulbs, street lights, and torch bulbs.', image: 'resources/startups/kaytee-768x174-1-300x68.png' },
  ...
  { id: 'kayteecouriers', name: 'Kaytee Couriers', description: 'A cargo and logistics platform with a presence in over 251 cities across 20 states.', image: 'resources/startups/KayteeLite-768x174-1-300x68.png' },
  { id: 'kayteepharma', name: 'Kaytee Pharma', description: 'A pharmaceutical research and trade unit catering to the research and trade needs of corporate clients.', image: 'resources/startups/sdb-768x174-1-300x68.png' },
  { id: 'kayteeinfra', name: 'Kaytee Infra & Developers', description: 'A real estate company focused on projects like flats, apartments, and row houses for a diverse clientele.', image: 'resources/startups/k2f-768x174-1-300x68.png' },
  { id: 'konnect2friends', name: 'Konnect 2 Friends', description: 'A social media platform for developing and promoting social networks for individuals and corporates.', image: 'resources/startups/c2f-768x174-1-300x68.png' },
  { id: 'konnect2market', name: 'Konnect 2 Market', description: 'An aggregator marketplace SBU for classified ad purposes, catering to a wide range of users.', image: 'resources/startups/newway-768x174-1-300x68.png' },
  { id: 'way2mysolutions', name: 'Way 2 My Solutions', description: 'A Business-to-Customer (B2C) consultancy SBU that helps non-performing or sick companies.', image: 'resources/startups/way2-768x174-1-300x68.png' },
  ...
  { id: 'myschoolsolutions', name: 'My School Solutions', description: 'Provides online exam solutions for schools, colleges, and universities.', image: 'resources/startups/kaytee-768x174-1-300x68.png' },
